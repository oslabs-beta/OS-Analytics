  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route 
          path="/login" 
          element={activeUser ? <Navigate to={window.location.pathname !== '/login' ? window.location.pathname : '/dashboard'} /> : <Login />} 
        />
        <Route path="/signup" element={activeUser ? <Navigate to={window.location.pathname !== '/signup' ? window.location.pathname : '/dashboard'} /> : <Signup />} />
